...
import { fetchNoticeAction } from "@/data/notices/actions";
import type { NoticeDetail } from "@/data/notices/schema";
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-start justify-between gap-3">
                ...
                <Badge variant={detail.active ? "default" : "secondary"}>{detail.active ? "활성" : "비활성"}</Badge>
              </div>
